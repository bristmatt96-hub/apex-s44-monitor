...
**System is deployed and running on VPS (143.198.56.117)**
...
|-----------|----------|--------|---------|
| SEC Filing Monitor | DigitalOcean VPS | Running 24/7 | IP: 143.198.56.117 |
...
|---------|--------|---------|
| DigitalOcean | ✅ Active | SSH: `ssh root@143.198.56.117` |
...
|-----------|------|-----------|---------|
| app.mb-trading.co.uk | A | 143.198.56.117 | Dashboard API (VPS) |
