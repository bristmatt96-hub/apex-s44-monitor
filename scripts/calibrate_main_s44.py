"""Calibrate Gaussian copula to real iTraxx Main S44 dealer quotes."""
import sys
sys.path.insert(0, ".")
...
INDEX = 53.0    # Main S44 5Y ref spread
RUNNING = 100   # 1% running coupon (100bp) on all tranches — ISDA IG standard

# Real dealer quotes — iTraxx Main S44
...
print("=" * 90)
print("  iTraxx MAIN S44 — BASE CORRELATION CALIBRATION")
...
# S42 vs S44 comparison hint
print(f"\n  NOTE: Compare with Main S42 (ref 42bp) for roll analysis")

print(f"\n{'=' * 100}")
print("  Model: 1F Gaussian copula (LHP), ISDA 40% recovery, 3% risk-free, quarterly")
print("  Calibrated from real iTraxx Main S44 dealer quotes")
print("=" * 100)
