"""Calibrate Gaussian copula to real Xover S42 dealer quotes."""
import sys
sys.path.insert(0, ".")
...
INDEX = 250.0   # Xover S42 ref
RUNNING = 500   # 5% running coupon on all tranches

# Real dealer quotes — Xover S42
# Equity/Mezz: upfront %, Senior: upfront %, Super Sr: conventional spread (bp)
MARKET = [
...
print("=" * 90)
print("  iTraxx CROSSOVER S42 — BASE CORRELATION CALIBRATION")
...
print("  Calibrated from real Xover S42 dealer quotes")
print("=" * 100)
